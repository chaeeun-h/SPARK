...
# Config
# =========================
MODEL_DIR = "./kobert_spark_korean_finetuned"  # KR-ELECTRA model directory
TEST_FILE = "./spark_korean_test.json"          # Korean test data

# Create logs directory
os.makedirs("./logs/krelectra_spark_korean", exist_ok=True)

# Setup logging to file
log_filename = f"./logs/krelectra_spark_korean/evaluation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
log_print(f"Loaded KR-ELECTRA model from {MODEL_DIR}")
...
# =========================
log_print("\n" + "="*50)
log_print("KR-ELECTRA SPARK Model Evaluation Results")
log_print("="*50)
