...
LANGUAGE = "english"  # BERT for English text
...
OUTPUT_DIR = f"./data/bert_spark_{LANGUAGE}_finetuned"
...
training_args = TrainingArguments(
    ...
    logging_dir=f"./logs/bert_spark_{LANGUAGE}",
    learning_rate=2e-5,
...
# Train
# =========================
print(f"\nStarting training for {LANGUAGE} SPARK dataset with BERT...")
trainer.train()
