...
# Config
# =========================
MODEL_DIR = "./bert_spark_english_finetuned"  # BERT model directory
TEST_FILE = "./data/spark_english_test.json"  # English test data

# Create logs directory
os.makedirs("./logs/bert_spark_english", exist_ok=True)

# Setup logging to file
log_filename = f"./logs/bert_spark_english/evaluation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
log_print(f"Loaded BERT model from {MODEL_DIR}")
...
# =========================
log_print("\n" + "="*50)
log_print("BERT SPARK Model Evaluation Results")
log_print("="*50)
