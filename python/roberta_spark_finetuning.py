...
OUTPUT_DIR = f"./data/roberta_spark_{LANGUAGE}_finetuned"
...
# =========================
# Model
# Note: loading from GoEmotions checkpoint but re-training
# classification head for SPARK's label space
# =========================
...
training_args = TrainingArguments(
    ...
    logging_dir                 = f"./logs/roberta_spark_{LANGUAGE}",
    learning_rate               = 1e-5,
...
# Train & evaluate
# =========================
print(f"\nStarting training — RoBERTa ({LANGUAGE})...")
trainer.train()
