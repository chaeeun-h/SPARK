...
# Config
# =========================
MODEL_DIR = "./roberta_spark_english_finetuned"  # Change to "korean" for Korean model
TEST_FILE = "./spark_english_test.json"  # Change to "korean" for Korean test

# Create logs directory
os.makedirs("./logs/roberta_spark_english", exist_ok=True)

# Setup logging to file
log_filename = f"./logs/roberta_spark_english/evaluation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
log_print(f"Loaded model from {MODEL_DIR}")
...
# =========================
log_print("\n" + "="*50)
log_print("RoBERTa SPARK Model Evaluation Results")
log_print("="*50)
