...
MODEL_DIR = f"./roberta_spark_{LANGUAGE}_finetuned" 
TEST_FILE = f"./data/spark_{LANGUAGE}_test.json"  

# Create logs directory
os.makedirs(f"./logs/roberta_spark_{LANGUAGE}", exist_ok=True)

# Setup logging to file
log_filename = f"./logs/roberta_spark_{LANGUAGE}/evaluation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
