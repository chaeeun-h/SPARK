...
# Fix KoBERT tokenizer saving bug with newer transformers
_original_save_vocabulary = tokenizer.save_vocabulary

def patched_save_vocabulary(self, save_directory, filename_prefix=None):
    return _original_save_vocabulary(save_directory)

tokenizer.save_vocabulary = types.MethodType(
    patched_save_vocabulary,
    tokenizer
)
...
# Train
# =========================
print(f"\nStarting training — KoBERT ({LANGUAGE})...")
trainer.train()
...
print("Note: tokenizer saving was patched for KoBERT compatibility.")