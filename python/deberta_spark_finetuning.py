...
# Config
# =========================
MODEL_NAME = "microsoft/deberta-base"  # DeBERTa model
LANGUAGE = "english"  # DeBERTa for English text

TRAIN_FILE = f"./spark_{LANGUAGE}_train.json"
VALID_FILE = f"./spark_{LANGUAGE}_val.json"
TEST_FILE = f"./spark_{LANGUAGE}_test.json"
OUTPUT_DIR = f"./deberta_spark_{LANGUAGE}_finetuned"
...
# Train
# =========================
print(f"\nStarting training for {LANGUAGE} SPARK dataset with DeBERTa...")
trainer.train()
