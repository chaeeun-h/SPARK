...
# Config
# =========================
MODEL_DIR = "./deberta_spark_english_finetuned"  # DeBERTa model directory
TEST_FILE = "./spark_english_test.json"  # English test data

# Create logs directory
os.makedirs("./logs/deberta_spark_english", exist_ok=True)

# Setup logging to file
log_filename = f"./logs/deberta_spark_english/evaluation_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
log_print(f"Loaded DeBERTa model from {MODEL_DIR}")
...
# =========================
log_print("\n" + "="*50)
log_print("DeBERTa SPARK Model Evaluation Results")
log_print("="*50)
